...
// API URL
const URL = "https://kffjc39iea.execute-api.us-east-1.amazonaws.com/test/media/" + mediafile_id + "/evaluate";
...
const bar_messages = {
  ...
  'arm_swing': 'お子様の腕のふり幅は平均よりも{value}です。もっと大きく腕を振ると、効率的に力を伝える事ができます。男の子は縦、女の子は横に腕を振ると良いと言われています。'
};

// 棒グラフ
const Bar = function(props) {
  const message = props.title_en in bar_messages ? bar_messages[props.title_en] : '';
